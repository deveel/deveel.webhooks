...
namespace Deveel.Webhooks {
	public static class WebhookReceiverConfigurationBuilderExtensions {
		...
		public static IWebhookReceiverConfigurationBuilder AddReceiver<TWebhook>(this IWebhookReceiverConfigurationBuilder builder, ServiceLifetime lifetime = ServiceLifetime.Scoped)
			where TWebhook : class
