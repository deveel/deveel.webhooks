...
namespace Deveel.Webhooks {
	public static class WebhookReceiverBuilderExtensions {
		public static IWebhookReceiverBuilder AddReceiver<TReceiver, TWebhook>(this IWebhookReceiverBuilder builder, ServiceLifetime lifetime = ServiceLifetime.Singleton)
		...
		public static IWebhookReceiverBuilder AddReceiver<TWebhook>(this IWebhookReceiverBuilder builder, ServiceLifetime lifetime = ServiceLifetime.Singleton)
			where TWebhook : class
